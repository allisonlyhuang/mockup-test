...
// Eye positions as % of the face image dimensions (208×209 viewBox)
// Update these once you swap in the eyeless SVG if eye placement shifts
    ...
    <>
      ...
      <style>{`
        ...
        .hero-subtitle {
          ...
          line-height: normal;
          margin: clamp(-2rem, -4vw, -0.5rem) 0 0;
          animation-name: hero-rise;
